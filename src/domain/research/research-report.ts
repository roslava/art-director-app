...
import { researchUncertaintySchema, visualOpportunitySchema, visualPropertySchema, visualRiskSchema } from "./visual-properties";
...
export const researchReportSchema = z.object({
  ...
  uncertainties: z.array(researchUncertaintySchema).default([]),
